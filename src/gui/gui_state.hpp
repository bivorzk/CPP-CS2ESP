...
static constexpr int ID_TAB_BASE = 700;  // sidebar button IDs: 700–706
...
enum CtrlID : int {
    ...
    ID_VIS_CENTER,             ID_VIS_OPACITY, ID_VIS_OPACITY_LBL,
    ID_VIS_R,                  ID_VIS_R_LBL,   ID_VIS_G, ID_VIS_G_LBL,
    ID_VIS_B,                  ID_VIS_B_LBL,
    ID_VIS_SHOW_TEAM_A,
    ID_VIS_AUTO_AIM, ID_VIS_ALT_FIRE, ID_VIS_STRICT_VIS, ID_VIS_AIM_PART, ID_VIS_COOLDOWN, ID_MEM_LIST         = 300, ID_MEM_CURVAL,  ID_MEM_WRITEVAL, ID_MEM_WRITEBTN,
